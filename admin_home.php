                                 ...
                                 <div class="modal-dialog" role="document">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-body">
                                             ...
                                             <form method="post" action="admin_edit_users.php">
                                             ...
                                             <input type="text" class="form-control" name="id" value="' . $row["id"] . '" hidden>
                                                 ...
                                                 <div class="form-group">
                                                     <label>Gender</label>
                                                     <input type="text" class="form-control" name="sex" value="' . $row["sex"] . '"  required>
                                                 </div>
                                                 ...
                                                 <button class="btn btn-primary form-control">Update User</button>
                                             </form>
