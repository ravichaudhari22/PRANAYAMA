    ...
    <div class="container-fluid" style="margin-top:10px    ;">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a> <button data-toggle="modal" data-target="#addrecepies" class=" primary-btn" style="float:right;margin:20px;" hidden> Add Recepies </button> </a>

                <div class="modal fade" id="addrecepies" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="exampleModalLabel">Add Recepie</h3>
                            ...
                            <div class="modal-body">
                                ...
                                <form method="post" action="admin_add_recepie.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="ingredients" required rows="5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="instructions" required rows="5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category">
                                            ...
                                            <option value="nonveg">Non-Vegetarien</option>
                                        </select>
                                    </div>
                                    ...
                                    <button class="btn btn-primary form-control" type="submit">Add Recepie</button>
                                </form>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo '
                                    ...
                                    <td>
                                             ...
                                             <a href="delete_recepie.php?id=' . $row["rid"] . '"> Delete </a>
                                    </td>

                                    <td>
                                       <a   data-toggle="modal" data-target="#' . $row["rid"] . '" style="cursor:pointer"> Edit </a>
                                    </td>
                                ...
                                <div class="modal fade" id="' . $row["rid"] . '"   role="dialog"   aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 class="modal-title" id="exampleModalLabel">Update Recipes</h3>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                ...
                                                <form method="post" action="admin_edit_receipes.php">

                                                <input type="text" class="form-control" name="rid" value="' . $row["rid"] . '" readonly>


                                                    <div class="form-group">
                                                        <label>Name</label>
                                                        <input type="text" class="form-control" name="recepie_name" value="' . $row["recepie_name"] . '" required>
